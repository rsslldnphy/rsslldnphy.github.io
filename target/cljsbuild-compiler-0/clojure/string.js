...
{return s.replace((new RegExp((function (){var G__15048 = match;return goog.string.regExpEscape(G__15048);
})(),"g")),replacement);
} else
...
{{
var G__15049 = cljs.core.pop(v__$1);
v__$1 = G__15049;
continue;
}
} else
...
{var pred__15057 = cljs.core._EQ_;var expr__15058 = limit;if(cljs.core.truth_((function (){var G__15060 = (1);var G__15061 = expr__15058;return (pred__15057.cljs$core$IFn$_invoke$arity$2 ? pred__15057.cljs$core$IFn$_invoke$arity$2(G__15060,G__15061) : pred__15057.call(null,G__15060,G__15061));
})()))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_((function (){var G__15062 = (2);var G__15063 = expr__15058;return (pred__15057.cljs$core$IFn$_invoke$arity$2 ? pred__15057.cljs$core$IFn$_invoke$arity$2(G__15062,G__15063) : pred__15057.call(null,G__15062,G__15063));
})()))
...
var G__15067 = s__$1.substring((index + cljs.core.count(m)));
var G__15068 = (limit__$1 - (1));
var G__15069 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(parts,s__$1.substring((0),index));
s__$1 = G__15067;
limit__$1 = G__15068;
parts = G__15069;
continue;
...
*/
clojure.string.trim = (function trim(s){var G__15071 = s;return goog.string.trim(G__15071);
});
/**
* Removes whitespace from the left side of string.
*/
clojure.string.triml = (function triml(s){var G__15073 = s;return goog.string.trimLeft(G__15073);
});
/**
* Removes whitespace from the right side of string.
*/
clojure.string.trimr = (function trimr(s){var G__15075 = s;return goog.string.trimRight(G__15075);
});
/**
...
*/
clojure.string.blank_QMARK_ = (function blank_QMARK_(s){var G__15078 = s;return goog.string.isEmptySafe(G__15078);
});
/**
...
{var ch = s.charAt(index);var temp__4124__auto___15079 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cmap,ch);if(cljs.core.truth_(temp__4124__auto___15079))
{var replacement_15080 = temp__4124__auto___15079;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_15080)));
} else
{buffer.append(ch);
}
{
var G__15081 = (index + (1));
index = G__15081;
continue;
}
}
