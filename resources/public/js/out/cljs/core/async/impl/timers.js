...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__16403__auto__,writer__16404__auto__,opt__16405__auto__){return cljs.core._write.call(null,writer__16404__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_26242 = (0);while(true){
if((i_26242 < arr.length))
{(arr[i_26242] = null);
{
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__16403__auto__,writer__16404__auto__,opt__16405__auto__){return cljs.core._write.call(null,writer__16404__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_26249 = (self__.level + (1));while(true){
if((i_26249 <= (new_level + (1))))
{(update[i_26249] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_26251 = (0);while(true){
if((i_26251 <= self__.level))
{var links_26252 = (update[i_26251]).forward;if(((links_26252[i_26251]) === x__$1))
{(links_26252[i_26251] = (x__$1.forward[i_26251]));
{
var G__26253 = (i_26251 + (1));
i_26251 = G__26253;
continue;
}
} else
{{
var G__26254 = (i_26251 + (1));
i_26251 = G__26254;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__15826__auto__ = (cljs.core.truth_((function (){var and__15814__auto__ = me;if(cljs.core.truth_(and__15814__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__15814__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__15826__auto__))
...
cljs.core.async.impl.dispatch.queue_delay.call(null,((function (timeout_channel,or__15826__auto__,timeout__$1,me){
return (function (){cljs.core.async.impl.timers.timeouts_map.remove(timeout__$1);
return cljs.core.async.impl.protocols.close_BANG_.call(null,timeout_channel);
});})(timeout_channel,or__15826__auto__,timeout__$1,me))
,msecs);
