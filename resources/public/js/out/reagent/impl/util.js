...
{var name_str = cljs.core.name.call(null,dashed);var vec__21551 = clojure.string.split.call(null,name_str,/-/);var start = cljs.core.nth.call(null,vec__21551,(0),null);var parts = cljs.core.nthnext.call(null,vec__21551,(1));if(cljs.core.truth_(reagent.impl.util.dont_camel_case.call(null,start)))
{return name_str;
} else
...
reagent.impl.util.partial_ifn.cljs$lang$ctorPrWriter = (function (this__16403__auto__,writer__16404__auto__,opt__16405__auto__){return cljs.core._write.call(null,writer__16404__auto__,"reagent.impl.util/partial-ifn");
});
...
var G__21553__delegate = function (self__,a){var self____$1 = this;var _ = self____$1;var or__15826__auto___21554 = self__.p;if(cljs.core.truth_(or__15826__auto___21554))
{} else
{self__.p = cljs.core.apply.call(null,cljs.core.partial,self__.f,self__.args);
}
return cljs.core.apply.call(null,self__.p,a);
};
var G__21553 = function (self__,var_args){
var self__ = this;
var a = null;if (arguments.length > 1) {
  a = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return G__21553__delegate.call(this,self__,a);};
G__21553.cljs$lang$maxFixedArity = 1;
G__21553.cljs$lang$applyTo = (function (arglist__21555){
var self__ = cljs.core.first(arglist__21555);
var a = cljs.core.rest(arglist__21555);
return G__21553__delegate(self__,a);
});
G__21553.cljs$core$IFn$_invoke$arity$variadic = G__21553__delegate;
return G__21553;
})()
;
reagent.impl.util.partial_ifn.prototype.apply = (function (self__,args21552){var self__ = this;
var self____$1 = this;return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone.call(null,args21552)));
});
reagent.impl.util.partial_ifn.prototype.cljs$core$IFn$_invoke$arity$2 = (function() { 
var G__21556__delegate = function (a){var _ = this;var or__15826__auto___21557 = self__.p;if(cljs.core.truth_(or__15826__auto___21557))
{} else
{self__.p = cljs.core.apply.call(null,cljs.core.partial,self__.f,self__.args);
}
return cljs.core.apply.call(null,self__.p,a);
...
return G__21556__delegate.call(this,a);};
G__21556.cljs$lang$maxFixedArity = 0;
G__21556.cljs$lang$applyTo = (function (arglist__21558){
var a = cljs.core.seq(arglist__21558);
return G__21556__delegate(a);
});
...
reagent.impl.util.clj_ifn_QMARK_ = (function clj_ifn_QMARK_(x){var or__15826__auto__ = cljs.core.ifn_QMARK_.call(null,x);if(or__15826__auto__)
{return or__15826__auto__;
} else
{var G__21562 = x;if(G__21562)
{var bit__16490__auto__ = (G__21562.cljs$lang$protocol_mask$partition1$ & (256));if((bit__16490__auto__) || (G__21562.cljs$core$IMultiFn$))
{return true;
} else
{if((!G__21562.cljs$lang$protocol_mask$partition1$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IMultiFn,G__21562);
} else
{return false;
}
}
...
reagent.impl.util._not_found = (function (){var obj21564 = {};return obj21564;
})();
...
reagent.impl.util.shallow_equal_maps = (function shallow_equal_maps(x,y){var or__15826__auto__ = (x === y);if(or__15826__auto__)
{return or__15826__auto__;
} else
{var and__15814__auto__ = cljs.core.map_QMARK_.call(null,x);if(and__15814__auto__)
{var and__15814__auto____$1 = cljs.core.map_QMARK_.call(null,y);if(and__15814__auto____$1)
{var and__15814__auto____$2 = (cljs.core.count.call(null,x) === cljs.core.count.call(null,y));if(and__15814__auto____$2)
{return cljs.core.reduce_kv.call(null,((function (and__15814__auto____$2,and__15814__auto____$1,and__15814__auto__,or__15826__auto__){
return (function (res,k,v){var yv = cljs.core.get.call(null,y,k,reagent.impl.util._not_found);if(cljs.core.truth_((function (){var or__15826__auto____$1 = (v === yv);if(or__15826__auto____$1)
{return or__15826__auto____$1;
} else
{var or__15826__auto____$2 = reagent.impl.util.identical_ish_QMARK_.call(null,v,yv);if(or__15826__auto____$2)
{return or__15826__auto____$2;
} else
{var and__15814__auto____$3 = cljs.core.keyword_identical_QMARK_.call(null,k,new cljs.core.Keyword(null,"style","style",-496642736));if(and__15814__auto____$3)
...
});})(and__15814__auto____$2,and__15814__auto____$1,and__15814__auto__,or__15826__auto__))
,true,x);
} else
...
var or__15826__auto__ = (v1 === v2);if(or__15826__auto__)
{return or__15826__auto__;
} else
{var and__15814__auto__ = (cljs.core.count.call(null,v1) === cljs.core.count.call(null,v2));if(and__15814__auto__)
{return cljs.core.reduce_kv.call(null,((function (and__15814__auto__,or__15826__auto__){
return (function (res,k,v){var v_SINGLEQUOTE_ = cljs.core.nth.call(null,v2,k);if(cljs.core.truth_((function (){var or__15826__auto____$1 = (v === v_SINGLEQUOTE_);if(or__15826__auto____$1)
{return or__15826__auto____$1;
} else
{var or__15826__auto____$2 = reagent.impl.util.identical_ish_QMARK_.call(null,v,v_SINGLEQUOTE_);if(or__15826__auto____$2)
{return or__15826__auto____$2;
} else
{var and__15814__auto____$1 = cljs.core.map_QMARK_.call(null,v);if(and__15814__auto____$1)
...
});})(and__15814__auto__,or__15826__auto__))
,true,v1);
} else
{return and__15814__auto__;
}
