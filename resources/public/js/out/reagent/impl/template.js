...
{return (function() { 
var G__21425__delegate = function (args){return cljs.core.apply.call(null,v,args);
};
...
var args = cljs.core.seq(arglist__21426);
...
reagent.impl.template.undash_prop_name = (function undash_prop_name(n){var or__15826__auto__ = reagent.impl.template.attr_aliases.call(null,n);if(cljs.core.truth_(or__15826__auto__))
...
{return cljs.core.reduce_kv.call(null,(function (res,k,v){var G__21428 = res;(G__21428[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.to_js_val.call(null,v));
return G__21428;
}),{},val);
} else
...
reagent.impl.template.set_id_class = (function set_id_class(props,p__21429){var vec__21431 = p__21429;var id = cljs.core.nth.call(null,vec__21431,(0),null);var class$ = cljs.core.nth.call(null,vec__21431,(1),null);var pid = (props["id"]);(props["id"] = ((!((pid == null)))?pid:id));
if((class$ == null))
{return null;
} else
...
{var objprops = cljs.core.reduce_kv.call(null,(function (o,k,v){var pname_21432 = reagent.impl.template.cached_prop_name.call(null,k);if(!((pname_21432 === "key")))
{(o[pname_21432] = reagent.impl.template.convert_prop_value.call(null,v));
} else
{}
return o;
...
var G__21435 = jsprops;(G__21435["defaultValue"] = value);
(G__21435["value"] = null);
(G__21435["onChange"] = ((function (G__21435,on_change,value){
return (function (p1__21433_SHARP_){return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__21433_SHARP_);
});})(G__21435,on_change,value))
);
return G__21435;
}
});
...
reagent.impl.template.parse_tag = (function parse_tag(hiccup_tag){var vec__21441 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));var tag = cljs.core.nth.call(null,vec__21441,(0),null);var id = cljs.core.nth.call(null,vec__21441,(1),null);var class$ = cljs.core.nth.call(null,vec__21441,(2),null);var comp = (reagent.impl.template.DOM[tag]);var class_SINGLEQUOTE_ = (cljs.core.truth_(class$)?clojure.string.replace.call(null,class$,/\./," "):null);if(cljs.core.truth_(comp))
{} else
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [comp,(cljs.core.truth_((function (){var or__15826__auto__ = id;if(cljs.core.truth_(or__15826__auto__))
{return or__15826__auto__;
} else
...
reagent.impl.template.get_wrapper = (function get_wrapper(tag){var vec__21443 = reagent.impl.template.parse_tag.call(null,tag);var comp = cljs.core.nth.call(null,vec__21443,(0),null);var id_class = cljs.core.nth.call(null,vec__21443,(1),null);return reagent.impl.template.wrap_component.call(null,comp,id_class,(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(tag)));
});
...
var c = reagent.impl.template.as_class.call(null,cljs.core.nth.call(null,v,(0)));var jsprops = (function (){var obj21447 = {};(obj21447[reagent.impl.util.cljs_argv] = v);
(obj21447[reagent.impl.util.cljs_level] = level);
return obj21447;
})();var k_21448 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,v));var k_SINGLEQUOTE__21449 = (((k_21448 == null))?reagent.impl.template.get_key.call(null,cljs.core.nth.call(null,v,(1),null)):k_21448);if((k_SINGLEQUOTE__21449 == null))
{} else
{(jsprops["key"] = k_SINGLEQUOTE__21449);
}
...
reagent.impl.template.expand_seq = (function expand_seq(s,level){var a = cljs.core.into_array.call(null,s);var level_SINGLEQUOTE_ = (level + (1));var n__16696__auto___21450 = a.length;var i_21451 = (0);while(true){
if((i_21451 < n__16696__auto___21450))
{(a[i_21451] = reagent.impl.template.as_component.call(null,(a[i_21451]),level_SINGLEQUOTE_));
{
...
reagent.impl.template.convert_args = (function convert_args(argv,first_child,level){var a = cljs.core.into_array.call(null,argv);var n__16696__auto___21453 = a.length;var i_21454 = (0);while(true){
if((i_21454 < n__16696__auto___21453))
{if((i_21454 >= first_child))
{(a[i_21454] = reagent.impl.template.as_component.call(null,(a[i_21454]),level));
} else
{}
{
