...
reagent.impl.batching.next_tick = ((cljs.core.not.call(null,reagent.impl.util.is_client))?reagent.impl.batching.fake_raf:(function (){var w = window;var or__15826__auto__ = w.requestAnimationFrame;if(cljs.core.truth_(or__15826__auto__))
{return or__15826__auto__;
} else
{var or__15826__auto____$1 = w.webkitRequestAnimationFrame;if(cljs.core.truth_(or__15826__auto____$1))
{return or__15826__auto____$1;
} else
{var or__15826__auto____$2 = w.mozRequestAnimationFrame;if(cljs.core.truth_(or__15826__auto____$2))
{return or__15826__auto____$2;
} else
{var or__15826__auto____$3 = w.msRequestAnimationFrame;if(cljs.core.truth_(or__15826__auto____$3))
...
var n__16696__auto__ = a.length;var i = (0);while(true){
if((i < n__16696__auto__))
{var C_21408 = (a[i]);if(cljs.core.truth_(C_21408.cljsIsDirty))
{C_21408.forceUpdate();
} else
{}
{
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__16403__auto__,writer__16404__auto__,opt__16405__auto__){return cljs.core._write.call(null,writer__16404__auto__,"reagent.impl.batching/RenderQueue");
});
...
reagent.impl.batching.is_reagent_component = (function is_reagent_component(C){var and__15814__auto__ = !((C == null));if(and__15814__auto__)
{var and__15814__auto____$1 = (C["props"]);if(cljs.core.truth_(and__15814__auto____$1))
...
reagent.impl.batching.dispose = (function dispose(C){var ratom_21410 = C.cljsRatom;if(!((ratom_21410 == null)))
{reagent.ratom.dispose_BANG_.call(null,ratom_21410);
} else
{}
