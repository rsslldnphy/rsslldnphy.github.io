...
var G__21389__delegate = function (x,rest){return cljs.core.apply.call(null,reagent.ratom.atom,x,rest);
};
var G__21389 = function (x,var_args){
var rest = null;if (arguments.length > 1) {
  rest = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return G__21389__delegate.call(this,x,rest);};
G__21389.cljs$lang$maxFixedArity = 1;
G__21389.cljs$lang$applyTo = (function (arglist__21390){
var x = cljs.core.first(arglist__21390);
var rest = cljs.core.rest(arglist__21390);
return G__21389__delegate(x,rest);
});
...
partial.cljs$lang$applyTo = (function (arglist__21391){
