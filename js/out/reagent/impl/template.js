...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__16776__auto__,writer__16777__auto__,opt__16778__auto__){
return cljs.core._write.call(null,writer__16777__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__27046 = o;
(G__27046[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
return (function() { 
var G__27047__delegate = function (args){
...
while (G__27048__i < G__27048__a.length) {G__27048__a[G__27048__i] = arguments[G__27048__i + 0]; ++G__27048__i;}
  args = new cljs.core.IndexedSeq(G__27048__a,0);
} 
return G__27047__delegate.call(this,args);};
G__27047.cljs$lang$maxFixedArity = 0;
G__27047.cljs$lang$applyTo = (function (arglist__27049){
var args = cljs.core.seq(arglist__27049);
return G__27047__delegate(args);
});
...
var old_27050 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_27050))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_27050)].join(''):class$));
} else {
}
...
if(cljs.core.truth_((function (){var and__16177__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__27053 = jsprops;
(G__27053["defaultValue"] = value);

(G__27053["onChange"] = ((function (G__27053,v,value,on_change){
return (function (p1__27051_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__27051_SHARP_);
});})(G__27053,v,value,on_change))
);
...
var vec__27055 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__27055,(0),null);
var id = cljs.core.nth.call(null,vec__27055,(1),null);
var class$ = cljs.core.nth.call(null,vec__27055,(2),null);
...
var temp__4128__auto__ = (function (){var G__27057 = cljs.core.meta.call(null,v);
var G__27057__$1 = (((G__27057 == null))?null:reagent.impl.template.get_key.call(null,G__27057));
return G__27057__$1;
})();
if((temp__4128__auto__ == null)){
...
var jsprops = {"argv": v};
var G__27059_27060 = v;
var G__27059_27061__$1 = (((G__27059_27060 == null))?null:reagent.impl.template.key_from_vec.call(null,G__27059_27060));
var G__27059_27062__$2 = (((G__27059_27061__$1 == null))?null:(jsprops["key"] = G__27059_27061__$1));
...
var p = (function (){var temp__4128__auto__ = (function (){var G__27065 = cljs.core.meta.call(null,argv);
var G__27065__$1 = (((G__27065 == null))?null:reagent.impl.template.get_key.call(null,G__27065));
return G__27065__$1;
})();
if((temp__4128__auto__ == null)){
return jsprops;
...
var G__27066 = (((jsprops == null))?{}:jsprops);
(G__27066["key"] = key);
...
var n__17076__auto___27067 = a.length;
var i_27068 = (0);
while(true){
if((i_27068 < n__17076__auto___27067)){
(a[i_27068] = reagent.impl.template.as_element.call(null,(a[i_27068])));

var G__27069 = (i_27068 + (1));
i_27068 = G__27069;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__17076__auto___27070 = a.length;
var i_27071 = (0);
while(true){
if((i_27071 < n__17076__auto___27070)){
var val_27072 = (a[i_27071]);
if((cljs.core.vector_QMARK_.call(null,val_27072)) && ((reagent.impl.template.key_from_vec.call(null,val_27072) == null))){
(o["no-key"] = true);
} else {
}

(a[i_27071] = reagent.impl.template.as_element.call(null,val_27072));

var G__27073 = (i_27071 + (1));
i_27071 = G__27073;
continue;
} else {
}
...
var G__27075 = (cljs.core.count.call(null,argv) - first_child);
switch (G__27075) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__27075){
